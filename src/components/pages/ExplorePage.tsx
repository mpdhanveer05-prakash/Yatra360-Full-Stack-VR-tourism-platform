      ...
      <div className="bg-bg-surface border-b border-[var(--border)]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6 space-y-4">
          <div className="flex items-end justify-between">
            <div>
              <p className="font-mono text-xs tracking-[0.3em] text-saffron uppercase mb-1">20 Destinations</p>
              <h1 className="font-cinzel text-2xl text-cream">Explore the World</h1>
            </div>
            {/* view toggle */}
